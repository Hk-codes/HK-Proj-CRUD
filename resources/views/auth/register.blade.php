    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-lg border-0 rounded-4" style="border-radius: 10px;"> <!-- Added rounded-4 for curved edges -->
                <div class="card-header text-center bg-gradient bg-success text-white rounded-top-4" style="border-radius: 5px;"> <!-- Rounded top edges for the header -->
                    <h4 class="fw-bold mb-0">Create Your Account</h4>
                    <p>Join us by registering below</p>
                </div>
            ...
            <div class="text-center mt-3">
                <p>Already have an account? <a href="{{ route('login') }}" class="fw-bold text-primary">Login here</a></p>
            </div>
        </div>
    </div>
</div>
