...
<div class="container">
    <h1>Edit Post</h1>
    <form action="{{ route('operator.posts.update', $post) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="price" name="price" required>{{ $post->price }}</textarea>
        </div>
        <div class="mb-3">
        ...
        <a href="{{ route('operator.posts.index') }}" class="btn btn-secondary ms-2">Cancel</a>
